...
var $author$project$Main$init = {inputText: '', todos: _List_Nil};
...
var $author$project$Main$addToList = F2(
	function (input, todos) {
		return _Utils_ap(
			...
			_List_fromArray(
				[
					{completed: false, editable: false, text: input}
				]));
	});
var $author$project$Main$editTodo = F2(
...
var $author$project$Main$saveEditTodo = F3(
	function (index, input, todos) {
		return A2(
			$elm$core$List$indexedMap,
			F2(
				function (currentIndex, todo) {
		...
		switch (msg.$) {
			...
			case 'AddTodo':
				return _Utils_update(
					...
					{
						inputText: '',
						todos: A2($author$project$Main$addToList, model.inputText, model.todos)
					});
			case 'EditTodo':
				var index = msg.a;
				return _Utils_update(
					model,
					{
						todos: A2($author$project$Main$editTodo, index, model.todos)
					});
			case 'SaveEditTodo':
				var input = msg.a;
				var index = msg.b;
				return _Utils_update(
					model,
					{
						todos: A3($author$project$Main$saveEditTodo, input, index, model.todos)
					});
			case 'RemoveTodo':
				var index = msg.a;
				return _Utils_update(
					model,
					{
						todos: A2($author$project$Main$removeFromList, index, model.todos)
					});
			case 'ToggleTodo':
				var index = msg.a;
				return _Utils_update(
					model,
					{
						todos: A2($author$project$Main$toggleTodo, index, model.todos)
					});
			default:
				var input = msg.a;
				return _Utils_update(
...
var $author$project$Main$fonts = {baseFont: 1, extraFont: 2, headingFont: 1.5};
...
var $author$project$Main$theme = {
	primary: $rtfeldman$elm_css$Css$hex('c7c7c7'),
...
var $author$project$Main$SaveEditTodo = F2(
	function (a, b) {
		return {$: 'SaveEditTodo', a: a, b: b};
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							todo.completed ? $rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$lineThrough) : $rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
							$rtfeldman$elm_css$Css$maxWidth($rtfeldman$elm_css$Css$maxContent),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$value(todo.text),
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
									todo.completed ? $rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$lineThrough) : $rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
									...
									$rtfeldman$elm_css$Css$rem($author$project$Main$fonts.headingFont)),
							...
							todo.editable ? false : true),
							$rtfeldman$elm_css$Html$Styled$Events$onInput(
							$author$project$Main$SaveEditTodo(index))
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Main$EditTodo(index)),
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$fontFamilies(
									_List_fromArray(
										['Courier New'])),
									$rtfeldman$elm_css$Css$fontSize(
									$rtfeldman$elm_css$Css$rem($author$project$Main$fonts.baseFont)),
									$rtfeldman$elm_css$Css$borderRadius(
									$rtfeldman$elm_css$Css$px(5)),
									$rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$transparent),
					...
					todo.editable ? _List_fromArray(
						[
							A2(
							$rtfeldman$elm_css$Html$Styled$img,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$src('./imgs/SaveIcon.svg'),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width(
						...
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$src('./imgs/EditIcon.svg'),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$type_('button'),
							$rtfeldman$elm_css$Html$Styled$Events$onClick(
							$author$project$Main$ToggleTodo(index)),
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$fontFamilies(
					...
					todo.completed ? _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$src('./imgs/ToggleOn.svg'),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width(
						...
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$src('./imgs/ToggleOff.svg'),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$src('./imgs/Delete.svg'),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Events$onSubmit($author$project$Main$AddTodo),
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Your todo tasks are')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$ChangeInput),
								$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('What do you want to do?'),
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$width(
										$rtfeldman$elm_css$Css$vw(65)),
										$rtfeldman$elm_css$Css$borderRadius(
										$rtfeldman$elm_css$Css$px(5)),
				...
				$elm$core$List$isEmpty(model.todos) ? A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('How come you have no tasks? 🤔')
					])) : A2(
				...
				_List_fromArray(
					[
						...
						A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'padding-inline-start', '0px')
					]),
